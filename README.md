...
https://universe.roboflow.com/ai-project-i3wje/waste-detection-vqkjo/browse?queryText=&pageSize=50&startingIndex=0&browseQuery=true
...
```bash
git clone https://github.com/adithyanvinod2003/waste-detection-using-YOLO.git
cd waste-detection
```
